...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, _______, LOWER,       KC_SPC,       RAISE,   KC_RALT, KC_RALT, FN,      KC_RCTL
),
...
[_LOWER] = LAYOUT_planck_mit(
  ...
  _______, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, KC_CIRC, KC_MINS, KC_4   , KC_5   , KC_6   , KC_SLSH, _______,
...
[_RAISE] = LAYOUT_planck_mit(
  ...
  _______, KC_QUOT, S(KC_QUOT), KC_LPRN, KC_RPRN, KC_PERC, _______, _______, _______, _______, _______, _______,
