...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, AU_TOGG, MU_TOGG, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, _______,
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, RGB_SPD, _______, RGB_SPI, _______, _______, DM_RSTP,                   COLEMAK, _______, KC_P1,   KC_P2,  KC_P3,   _______, GAME,
                                   _______, _______, _______, _______, _______, _______, _______, KC_NUM,  KC_P0, KC_PDOT,
